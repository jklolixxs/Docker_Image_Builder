...
## 4.检查路径
检查 **sing-box** 文件夹是否存在于 /opt/Docker_Image_Builder/ 路径中  

## 5.更改细节
用您喜欢的文本编辑器，编辑 `/opt/Docker_Image_Builder/sing-box/build.sh` 文件中的的内容  
...
```
* */1 * * * /opt/Docker_Image_Builder/sing-box/build.sh
```
